...
LANGUAGE_CODE = 'tr-tr' # Türkçe yaptım, istersen en-us kalsın
TIME_ZONE = 'UTC'
USE_I18N = True
USE_TZ = True
...
# ---------------------------------------------------------
# 📧 EMAIL AYARLARI (ANYMAIL - SENDGRID API) - DOĞRU OLAN BU
# ---------------------------------------------------------

# Render Dashboard -> Environment Variables kısmında 
# SENDGRID_API_KEY tanımlı olmalı!
...
if SENDGRID_API_KEY:
    # SMTP KULLANMIYORUZ! API KULLANIYORUZ.
